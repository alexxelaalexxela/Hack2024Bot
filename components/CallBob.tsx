...
export default function CallBob() {
  ...
  return (
    <div className="flex lg:flex-row lg:items-center lg:justify-center xxs:h-full flex-col items-center justify-end overflow-auto">
      <div className="lg:bg-[url(../public/assets/Bob.gif)] bg-cover lg:h-[400px] lg:w-[500px] w-full bg-no-repeat bg-contain bg-center xxs:bg-[url(../public/assets/Bob.gif)] xxs:bg-cover xxs:h-[500px] xxs:pt-20"></div>
